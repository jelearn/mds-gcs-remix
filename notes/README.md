...
- [`mitmproxy-dev-sandbox`](../reference-projects/mitmproxy-dev-sandbox/) (`mds`) — containerized VS Code + mitmproxy dev environment
- [`grepular-claude-sandbox`](../reference-projects/grepular-claude-sandbox/) (`gcs`) — single-file Python tool for running Claude CLI in Podman
